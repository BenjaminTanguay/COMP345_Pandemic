...
string & InfectionDeck::draw()
{
	...
	return dynamic_cast<CityCard *>(drawn)->getLocation()->getName();
}

string & InfectionDeck::epidemic()
{
	...
	return dynamic_cast<CityCard *>(bottom)->getLocation()->getName();
}
